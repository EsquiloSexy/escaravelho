...
<section id="form_register" class="container">
      <div class="content">
        <div id="register__inputs">
          <div id="content__form">
          <div class="input-group">
        ...
        <div class="input-group">
          ...
          <input type="date" class="form-control" placeholder="Email" aria-describedby="basic-addon1">
        </div>
        <div class="input-group">
          <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></span>
          <input type="text" class="form-control" placeholder="Selecione uma imagem" aria-describedby="basic-addon1">
        </div>
        <div id="radios">
          <input type="radio" name="sexo" value="M"> <span class="mgRight">Masculino</span>
